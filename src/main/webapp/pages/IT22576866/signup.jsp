...
<!-- Text -->
<p class="text-center" style="font-family: 'Ultra', serif; font-size: 60px;">Get access to musicmash</p>
<!-- Instructions -->
<p class="text-center" style="font-size: 20px;">First, tell us who you are.</p>
...
<div class="row">
  <div class="col">
    ...
    <a class="card-block stretched-link text-decoration-none" href="listenerInsert.jsp">
  ...
  <div class="col">
    ...
    <a class="card-block stretched-link text-decoration-none" href="../IT22581570/artist-signup.jsp">    
      <div class="card-body text-light">
