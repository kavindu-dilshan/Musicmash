...
<body>
	...
	<form action = "../../update" method = "post">
		...
		Listener First Name <input type = "text" name = "f_name" value = "<%=f_name%>"><br>	<!-- put 'value' to java variable 'f_name' -->
		Listener Last Name <input type = "text" name = "l_name" value = "<%=l_name%>"><br>	<!-- put 'value' to java variable 'l_name' -->
		Listener Phone Number <input type = "text" name = "phone" value = "<%=phone%>"><br>	<!-- put 'value' to java variable 'phone' -->
		Listener Email <input type = "text" name = "email" value = "<%=email%>"><br>			<!-- put 'value' to java variable 'email' -->
		Listener User Name <input type = "text" name = "uname" value = "<%=username%>"><br>	<!-- put 'value' to java variable 'username' -->
		Listener Password <input type = "text" name = "pass" value = "<%=password%>" required><br>	<!-- put 'value' to java variable 'password' -->
		
		<input type = "submit" name = "submit" value = "Update Listener Details"><br>
	</form>
