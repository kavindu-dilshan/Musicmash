...
String cardnumber = request.getParameter("cardn");
	...
	<br><h1 style="text-align: center;">Delete history</h1><br><br>
	...
	<tr>
		<td>Increment</td>
		<td><input type="text" name="autoincrement" value="<%= autoincrement %>"readonly></td>
	...
	<br>
	<input class="edit-button" type="submit" name="submit" value="Delete">
	</form>
